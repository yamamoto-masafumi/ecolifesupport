  ...
  <div id="inner-content">
      <main id="main" class="main" role="main" itemscope itemprop="mainContentOfPage" itemtype="http://schema.org/Blog">
        ...
        <header class="user-header">
          ...
          <?php if(wp_is_mobile()) : ?>
          <p class="userheader-bottom">HOME > <span>お客様の声 > </span><span>遠方で行けない自分の代わりに迅速な...</span></p>
          <?php else : ?>
          <p class="header-bottom">HOME > <span>お客様の声 > </span><span>遠方で行けない自分の代わりに迅速な対応をしていただけました。</span></p>
          <?php endif; ?>
            ...
            <div class="uservoicedetails-menu">
              <div class="uservoicedetails-title">
                  ...
                  <span class="interviewee">神奈川県 Kさん 遺品整理</span>
                  <h3>遠方で行けない自分の代わりに迅速な対応をしていただけました。</h3>
                  <div class="border"></div>
                <div class="inner-uservoicedetails">
                  <div class="uservoicedetails-blog">
                    <?php if(wp_is_mobile()) : ?>
                      <img src="<?php echo get_bloginfo('template_directory'); ?>/library/images/uservoice-details/sp-user-voice-details-12-1.jpg" alt="遺品整理依頼の男性">
                    <?php else : ?>
                      <img src="<?php echo get_bloginfo('template_directory'); ?>/library/images/uservoice-details/user-voice-details-12-1.jpg" alt="遺品整理依頼の男性">
                    <?php endif; ?>
                      <p>田舎の父親の遺品を整理しようと思いながら仕事もあるのでなかなか進まずにいました。<br>
                        エコライフサポートさんでは立会いがなくても行ってくれるということで頼みましたが、漏れのない丁寧な対応で安心して任せることが出来ました。
                        </p>
                      <br>
                      <h2>他人に立会いなしで家に入られるのは不安でしたが・・・</h2>
                    <?php if(wp_is_mobile()) : ?>
                      <img src="<?php echo get_bloginfo('template_directory'); ?>/library/images/uservoice-details/sp-user-voice-details-12-2.jpg" alt="やりとりの様子">
                    <?php else : ?>
                      <img src="<?php echo get_bloginfo('template_directory'); ?>/library/images/uservoice-details/user-voice-details-12-2.jpg" alt="やりとりの様子">
                    <?php endif; ?>
                      <p>新潟県の父親の遺品を整理しようと思ってもなかなか進まずにいました。<br>
                        母親は施設にいるし、兄弟はいないし、自分は自営業で忙しくなかなか帰ることができない状況。<br>
                        このままでは状況が変わらないと色々と業者を探しましたが、一番対応が早くて見積もりが安かったエコライフサポートさんに決めました。<br>
                        <br>
                        決定打は立会い不要ですね。<br>
                        しかも関東圏以外なのに追加料金がかからないことも嬉しいです。
                      </p>
                      <br>
                    <?php if(wp_is_mobile()) : ?>
                      <img src="<?php echo get_bloginfo('template_directory'); ?>/library/images/uservoice-details/sp-user-voice-details-12-3.jpg" alt="エコライフオペレーター">
                    <?php else : ?>
                      <img src="<?php echo get_bloginfo('template_directory'); ?>/library/images/uservoice-details/user-voice-details-12-3.jpg" alt="エコライフオペレーター">
                    <?php endif; ?>
                      <p>最初は電話で色々と丁寧に要望など聞いてくれて、とても安心感がありました。<br>
                        その後はメールでのやり取りをしたのですが、返事も早く不安になることはありませんでしたね。<br>
                        <br>
                        遺品整理後はこれでいいかの写真も送っていただき本当に助かりました。
                        </p>
                        <br>
                    <?php if(wp_is_mobile()) : ?>
                      <img src="<?php echo get_bloginfo('template_directory'); ?>/library/images/uservoice-details/sp-user-voice-details-12-4.jpg" alt="遺品整理後の部屋">
                    <?php else : ?>
                      <img src="<?php echo get_bloginfo('template_directory'); ?>/library/images/uservoice-details/user-voice-details-12-4.jpg" alt="遺品整理後の部屋">
                    <?php endif; ?>
                      <p>数ヶ月後やっと実家に帰ることができたので確認しましたが、漏れのない作業で安心しました。<br>
                        しかも掃除までしてくれてますね。<br>
                        床や畳が綺麗でした。<br>
                        <br>
                        大満足です！！<br>
                        遠方でなかなか遺品整理できない人にはぜひオススメしたいですね。
                        </p>
                        <br>
                        <div class="usage-table">
                            ...
                            <ul>
                              ...
                              <li class="itemtext4">
                                立会い不要でサービスを行ってくれる点。また、それに伴い作業を行うまでのやりとりが大変スムーズで安心感があるところ。
                              </li>
                            </ul>
                            <div class="borderblue"></div>
                            </div>
