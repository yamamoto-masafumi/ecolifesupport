  ...
  <div id="inner-content">
      <main id="main" class="main" role="main" itemscope itemprop="mainContentOfPage" itemtype="http://schema.org/Blog">
        ...
        <header class="user-header">
          ...
          <?php if(wp_is_mobile()) : ?>
          <p class="userheader-bottom">HOME > <span>お客様の声 > </span><span>明確な料金設定でどこよりも安く、安...</span></p>
          <?php else : ?>
          <p class="header-bottom">HOME > <span>お客様の声 > </span><span>明確な料金設定でどこよりも安く、安心して利用できました。</span></p>
          <?php endif; ?>
            ...
            <div class="uservoicedetails-menu">
              <div class="uservoicedetails-title">
                  ...
                  <h3>明確な料金設定でどこよりも安く、安心して利用できました。</h3>
                  <div class="border"></div>
                <div class="inner-uservoicedetails">
                  <div class="uservoicedetails-blog">
                    <?php if(wp_is_mobile()) : ?>
                      <img src="<?php echo get_bloginfo('template_directory'); ?>/library/images/uservoice-details/sp-user-voice-details-13-1.jpg" alt="生前処理依頼の家族">
                    <?php else : ?>
                      <img src="<?php echo get_bloginfo('template_directory'); ?>/library/images/uservoice-details/user-voice-details-13-1.jpg" alt="生前処理依頼の家族">
                    <?php endif; ?>
                      <p>家族に迷惑はかけたくないと思い身の回りの整理を頼みました。<br>
                        色々見積りを頼みましたが、他社は一つのものにつき回収料金が決まっていますが、エコライフサポートさんは乗せ放題のパック料金で安心して頼むことが出来ました。<br>
                        ありがとうございます。
                        </p>
                      <br>
                      <h2>親身に今後の相談に乗ってくれました。</h2>
                      <p>歳のせいもあり、日常的な整理整頓ができなくなったのがきっかけでこれを機に生前整理を頼みました。
                      </p>
                      <br>
                    <?php if(wp_is_mobile()) : ?>
                      <img src="<?php echo get_bloginfo('template_directory'); ?>/library/images/uservoice-details/sp-user-voice-details-13-2.jpg" alt="作業の様子">
                    <?php else : ?>
                      <img src="<?php echo get_bloginfo('template_directory'); ?>/library/images/uservoice-details/user-voice-details-13-2.jpg" alt="作業の様子">
                    <?php endif; ?>
                      <p>私たちと相談をしながら作業は進んでいきました。<br>
                        身辺整理を行ったことにより家具の配置換えなどもしていただき、その親切さにとても感謝です。<br>
                        家族に遺す目録の準備や重要書類系のことも一緒に教えてもらって、とても今後の参考になりました。
                        </p>
                        <br>
                    <?php if(wp_is_mobile()) : ?>
                      <img src="<?php echo get_bloginfo('template_directory'); ?>/library/images/uservoice-details/sp-user-voice-details-13-3.jpg" alt="生前処理作業後の部屋">
                    <?php else : ?>
                      <img src="<?php echo get_bloginfo('template_directory'); ?>/library/images/uservoice-details/user-voice-details-13-3.jpg" alt="生前処理作業後の部屋">
                    <?php endif; ?>
                      <p>部屋も綺麗に片付けていただき、エコライフサポートさんに頼んで本当によかったです！<br>
                        ここまでしていただいて3万円程でやっていただき、他の会社に問い合わせた見積もりよりも大幅に安くて大満足です。<br>
                        <br>
                        家族や孫のために今、きちんと整理できて良かったです。
                        </p>
                        <br>
                        <div class="usage-table">
                            ...
                            <ul>
                              ...
                              <li class="itemtext4">
                                書類の相談なども乗っていただきとても感謝。生前前処理の相談所に行く手間も省けました。
                              </li>
                            </ul>
                            <div class="borderblue"></div>
                            </div>
