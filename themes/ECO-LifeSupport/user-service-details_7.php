  ...
  <div id="inner-content">
      <main id="main" class="main" role="main" itemscope itemprop="mainContentOfPage" itemtype="http://schema.org/Blog">
        ...
        <header class="user-header">
          ...
          <?php if(wp_is_mobile()) : ?>
          <p class="userheader-bottom">HOME > <span>お客様の声 > </span><span>引っ越しに伴い家具を心機一転。格安で...</span></p>
          <?php else : ?>
          <p class="header-bottom">HOME > <span>お客様の声 > </span><span>引っ越しに伴い家具を心機一転。格安で回収してもらえました。</span></p>
          <?php endif; ?>

            <div class="uservoicedetails-menu">
              <div class="uservoicedetails-title">
                
                  <span class="label">粗大ゴミ回収　</span>
                  <span class="interviewee">埼玉県 Nさん 引っ越し</span>
                  <h3>引っ越しに伴い家具を心機一転。格安で回収してもらえました。</h3>
                  <div class="border"></div>
                <div class="inner-uservoicedetails">
                  <div class="uservoicedetails-blog">
                    <?php if(wp_is_mobile()) : ?>
                      <img src="<?php echo get_bloginfo('template_directory'); ?>/library/images/uservoice-details/sp-user-voice-details-7-1.jpg" alt="粗大ゴミ回収依頼の家族">
                    <?php else : ?>
                      <img src="<?php echo get_bloginfo('template_directory'); ?>/library/images/uservoice-details/user-voice-details-7-1.jpg" alt="粗大ゴミ回収依頼の家族">
                    <?php endif; ?>
                      <p>家族が増えたことにより今より広い部屋に引っ越しをします。<br>
                        今の家の家具を処分しようと思っい他の会社に見積りを依頼したら7万円。<br>
                        でもエコライフサポートさんでは2万円程で出来たので、浮いたお金で何を購入しようかワクワクしています。
                        </p>
                      <br>
                      <h2>見積りどおりのお値段にびっくり！お得です。</h2>
                    <?php if(wp_is_mobile()) : ?>
                      <img src="<?php echo get_bloginfo('template_directory'); ?>/library/images/uservoice-details/sp-user-voice-details-7-2.jpg" alt="粗大ゴミ回収の様子">
                    <?php else : ?>
                      <img src="<?php echo get_bloginfo('template_directory'); ?>/library/images/uservoice-details/user-voice-details-7-2.jpg" alt="粗大ゴミ回収の様子">
                    <?php endif; ?>
                      <p>こ電話ですぐに駆けつけていただいた時は、なんて仕事が早い業者なんだろと感心しました。<br>
                        以前は転勤族でその度家具処分や引っ越しをするたび、なんでこんなに遅いんだろうと少しイライラした経験もあったので、その点最初の段階で安心できました。<br>
                        <br>
                        結構大きめの家具ばかりだったので電話での見積もり2万円より多く取られるんじゃないかと思いましたが、そんなことはなく見積もりどおりのお値段で驚きましたよ！
                      </p>
                    <?php if(wp_is_mobile()) : ?>
                      <img src="<?php echo get_bloginfo('template_directory'); ?>/library/images/uservoice-details/sp-user-voice-details-7-3.jpg" alt="粗大ゴミ回収後の部屋">
                    <?php else : ?>
                      <img src="<?php echo get_bloginfo('template_directory'); ?>/library/images/uservoice-details/user-voice-details-7-3.jpg" alt="粗大ゴミ回収後の部屋">
                    <?php endif; ?>
                      <p>部屋も綺麗になって、その後すぐに新しい家具が届きました。<br>
                        迅速な対応に感謝です。<br>
                        他社が見積もり7万のところ2万円で出来たので、5万円分も得しちゃいましたね！<br>
                        エコライフサポートさんに頼んで本当によかったです♪
                        </p>
                        <br>
                    ...
                    <div class="uservoicelists">
                      ...
                      <div class="uservoice-list">
                          ...
                          <a href="<?php echo home_url('/user-voice/user9'); ?>"><img src="<?php echo get_bloginfo('template_directory'); ?>/library/images/user-voice/sp-user-voice9.jpg"></a>
                            ...
                            <p class="text"><a href="<?php echo home_url('/user-voice/user9'); ?>"><span class="detail">ご近所にバレずにあっという間に綺麗になりました！</span></a></p>
                            <div class="borderblue"></div>
                        </div>
                    </div>
                      ...
                      <p class="article">粗大ゴミ回収の関連記事</p>
                        ...
                        <div class="uservoice-list">
                          ...
                          <a href="<?php echo home_url('/user-voice/user8'); ?>"><img src="<?php echo get_bloginfo('template_directory'); ?>/library/images/user-voice/user-voice8.jpg"></a>
                            <span class="labelpc">粗大ゴミ回収</span>
                          </div>
                              <p class="title">千葉県 Kさん 一人暮らし</p>
                              <p class="text"><a href="<?php echo home_url('/user-voice/user8'); ?>"><span class="detail">引越しで2DK分の荷物が他社見積りの3分の1で出来ました！</span></a></p>
                              <div class="borderblue"></div>
                        </div>
                        ...
                        <div class="uservoice-list">
                          ...
                          <a href="<?php echo home_url('/user-voice/user9'); ?>"><img src="<?php echo get_bloginfo('template_directory'); ?>/library/images/user-voice/user-voice9.jpg"></a>
                            <span class="labelpc">粗大ゴミの回収</span>
                          </div>
                              <p class="title">東京都 Sさん 引っ越し</p>
