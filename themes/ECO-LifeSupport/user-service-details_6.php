  ...
  <div id="inner-content">
      <main id="main" class="main" role="main" itemscope itemprop="mainContentOfPage" itemtype="http://schema.org/Blog">
        ...
        <header class="user-header">
          ...
          <?php if(wp_is_mobile()) : ?>
          <p class="userheader-bottom">HOME > <span>お客様の声 > </span><span>散乱していたゴミが1時間で引っ越し...</span></p>
          <?php else : ?>
          <p class="header-bottom">HOME > <span>お客様の声 > </span><span>散乱していたゴミが1時間で引っ越ししたてのように！</span></p>
          <?php endif; ?>
            ...
            <div class="uservoicedetails-menu">
              <div class="uservoicedetails-title">
                  ...
                  <span class="interviewee">東京都 Sさん 一人暮らし</span>
                  <h3>散乱していたゴミが1時間で引っ越ししたてのように！</h3>
                  <div class="border"></div>
                <div class="inner-uservoicedetails">
                  <div class="uservoicedetails-blog">
                    <?php if(wp_is_mobile()) : ?>
                      <img src="<?php echo get_bloginfo('template_directory'); ?>/library/images/uservoice-details/sp-user-voice-details-6-1.jpg" alt="ゴミ屋敷の片付け依頼の男性">
                    <?php else : ?>
                      <img src="<?php echo get_bloginfo('template_directory'); ?>/library/images/uservoice-details/user-voice-details-6-1.jpg" alt="ゴミ屋敷の片付け依頼の男性">
                    <?php endif; ?>
                      <p>遅い帰宅が続き、気付けばゴミの残骸だらけに。彼女もできたけど部屋に呼べずにゴミの回収を頼みました。<br>
                        たった1時間であっという間に回収してくれて、彼女からも「男の人の一人暮らしなのにとっても綺麗だね」って言われました！
                        </p>
                      <br>
                      <h2>綺麗な部屋になると自信がつきますね！</h2>
                    <?php if(wp_is_mobile()) : ?>
                      <img src="<?php echo get_bloginfo('template_directory'); ?>/library/images/uservoice-details/sp-user-voice-details-6-2.jpg" alt="ゴミ屋敷片付け前の部屋">
                    <?php else : ?>
                      <img src="<?php echo get_bloginfo('template_directory'); ?>/library/images/uservoice-details/user-voice-details-6-2.jpg" alt="ゴミ屋敷片付け前の部屋">
                    <?php endif; ?>
                      <p>これが前の部屋だったんですがやばくないですか・・・<br>
                        結構タンスの中に物とかも詰め込んでて、これはやばいと思いながらも「男の人の一人暮らしってこんなものだよねきっと」<br>
                        と思いながら生活が続いていましたが！！！
                      </p>
                    <?php if(wp_is_mobile()) : ?>
                      <img src="<?php echo get_bloginfo('template_directory'); ?>/library/images/uservoice-details/sp-user-voice-details-6-3.jpg" alt="ゴミ屋敷片付け前の部屋">
                    <?php else : ?>
                      <img src="<?php echo get_bloginfo('template_directory'); ?>/library/images/uservoice-details/user-voice-details-6-3.jpg" alt="ゴミ屋敷片付け前の部屋">
                    <?php endif; ?>
                      <p>やっぱり彼女には綺麗な部屋に来てもらいたいじゃないですか！！<br>
                        そう思いましたが、もうここまで来たら掃除する気力もありませんし、どこから手をつけたらいいのかも分からなくて、なんならどれを捨てたらいいのかも分からない！！<br>
                        と思っていた時に安さと詰め放題という安心感に惹かれてエコライフサポートさんに依頼をしました。
                        </p>
                        <br>
                    <?php if(wp_is_mobile()) : ?>
                      <img src="<?php echo get_bloginfo('template_directory'); ?>/library/images/uservoice-details/sp-user-voice-details-6-4.jpg" alt="ゴミ屋敷片付け中">
                    <?php else : ?>
                      <img src="<?php echo get_bloginfo('template_directory'); ?>/library/images/uservoice-details/user-voice-details-6-4.jpg" alt="ゴミ屋敷片付け中">
                    <?php endif; ?>
                      <p>すぐに色々と取捨選択をしてゴミをまとめてくださり、その時間1時間もかかってないです。<br>
                        その後の掃除や家具の配置まで協力してくださりあまりの良心的な対応にとても感動しました。<br>
                        <br>
                        おかげで彼女を部屋に呼ぶことができて、とても部屋を気に入ってくれたようです！<br>
                        前の部屋に呼んでたら絶対ドン引きされてるところでした・・・<br>
                        <br>
                        エコライフサポートさん、ありがとうございました！
                        </p>
                        <div class="user-text">
                            <h5>
                              ※ご本人の希望で画像はイメージです
                ...
                <?php if(wp_is_mobile()) : ?>
                    <div class="uservoicelists">
                      <div class="uservoice-list">
                        <p class="article">ゴミ屋敷の片付けの関連記事</p>
                        <div class="imgbox">
                        <a href="<?php echo home_url('/user-voice/user4'); ?>"><img src="<?php echo get_bloginfo('template_directory'); ?>/library/images/user-voice/sp-user-voice4.jpg"></a>
                          ...
                          <p class="text"><a href="<?php echo home_url('/user-voice/user4'); ?>"><span class="detail">たったの29,800円で！片付けもしてくれて満足です。</span></a></p>
                          <div class="borderblue"></div>
                      </div>
                      <div class="uservoice-list">
                          <div class="imgbox">
                      ...
                      <p class="article">ゴミ屋敷の片付けの関連記事</p>
                        ...
                        <div class="uservoice-list">
                          ...
                          <a href="<?php echo home_url('/user-voice/user4'); ?>"><img src="<?php echo get_bloginfo('template_directory'); ?>/library/images/user-voice/user-voice4.jpg"></a>
                            <span class="labelpc">ゴミ屋敷の片付け</span>
                          </div>
                              <p class="title">東京都 Yさん 一人暮らし</p>
                              <p class="text"><a href="<?php echo home_url('/user-voice/user4'); ?>"><span class="detail">たったの29,800円で！片付けもしてくれて満足です。</span></a></p>
                              <div class="borderblue"></div>
                    ...
                    <div class="uservoicelisttitle">
                        ...
                        <div class="listbox">
                          ...
                          <div class="inner">
                            ...
                            <div class="labeltext">
                                <p class="label">不用品回収　</p>
                                <p class="interviewee"><a href="<?php echo home_url('/user-voice/user1'); ?>">東京都 Aさん 一人暮らし</a></p>
                            </div>
                          </div>
                          <div class="borderblue"></div>
                          ...
                          <div class="inner">
                            ...
                            <div class="labeltext">
                                <p class="label">粗大ゴミ回収　</p>
                                <p class="interviewee"><a href="<?php echo home_url('/user-voice/user7'); ?>">埼玉県 Nさん 引っ越し</a></p>
                            </div>
                          </div>
                          <div class="borderblue"></div>
                          ...
                          <div class="inner">
                            ...
                            <div class="labeltext">
                                <p class="label">遺品整理　</p>
                                <p class="interviewee"><a href="<?php echo home_url('/user-voice/user10'); ?>">神奈川県 Sさん 遺品整理</a></p>
                            </div>
                          </div>
                          <div class="borderblue"></div>
                          ...
                          <div class="inner">
                            ...
                            <div class="labeltext">
                                ...
                                <p class="interviewee"><a href="<?php echo home_url('/user-voice/user13'); ?>">埼玉県 Hさん 生前処分</a></p>
                            </div>
                          </div>
                          <div class="borderblue"></div>
                          ...
                          <div class="inner">
                            ...
                            <div class="labeltext">
                                <p class="label">不用品の買取　</p>
                                <p class="interviewee"><a href="<?php echo home_url('/user-voice/user16'); ?>">東京都 Nさん 不用品の買取</a></p>
                            </div>
                          </div>
                                <br>
                        </div>
                  ...
                  <div class="uservoicelist">
                    <div class="uservoicelisttitle">
                        ...
                        <p class="voicetitle">お客様の声</p>
                          ...
                          <div class="listbox">
                            <div class="imgbox">
                                <a href="<?php echo home_url('/user-voice/user1'); ?>"><div class="pcimg"><img src="<?php echo get_bloginfo('template_directory'); ?>/library/images/user-voice/user-voice1.jpg"></div></a>
                                <span class="label">不用品回収　</span><br>
                                <span class="interviewee"><a href="<?php echo home_url('/user-voice/user1'); ?>">東京都 Aさん 一人暮らし</a></span>
                                <div class="borderblue"></div>
                            </div>

                            <div class="imgbox">
                                  <a href="<?php echo home_url('/user-voice/user7'); ?>"><div class="pcimg"><img src="<?php echo get_bloginfo('template_directory'); ?>/library/images/user-voice/user-voice7.jpg"></div></a>
                                  <span class="label">粗大ゴミ回収　</span><br>
                                  <span class="interviewee"><a href="<?php echo home_url('/user-voice/user7'); ?>">埼玉県  Nさん 引っ越し</a></span>
                                  <div class="borderblue"></div>
                            </div>

                            <div class="imgbox">
                                  <a href="<?php echo home_url('/user-voice/user10'); ?>"><div class="pcimg"><img src="<?php echo get_bloginfo('template_directory'); ?>/library/images/user-voice/user-voice10.jpg"></div></a>
                                  <span class="label">遺品整理　</span><br>
                                  <span class="interviewee"><a href="<?php echo home_url('/user-voice/user10'); ?>">神奈川県 Sさん 遺品整理</a></span>
                                  <div class="borderblue"></div>
                            </div>

                            <div class="imgbox">
                                <a href="<?php echo home_url('/user-voice/user13'); ?>"><div class="pcimg"><img src="<?php echo get_bloginfo('template_directory'); ?>/library/images/user-voice/user-voice13.jpg"></div></a>
                                <span class="label">生前処理　</span><br>
                                <span class="interviewee"><a href="<?php echo home_url('/user-voice/user13'); ?>">埼玉県 Hさん 生前処分</a></span>
                                <div class="borderblue"></div>
                            </div>

                            <div class="imgbox">
                                <a href="<?php echo home_url('/user-voice/user16'); ?>"><div class="pcimg"><img src="<?php echo get_bloginfo('template_directory'); ?>/library/images/user-voice/user-voice16.jpg"></div></a>
                                <span class="label">不用品の買取　</span><br>
                                <span class="interviewee"><a href="<?php echo home_url('/user-voice/user16'); ?>">東京都 Nさん 不用品の買取</a></span>
                            </div>
                          </div>
                          <?php endif; ?>
                    </div>
