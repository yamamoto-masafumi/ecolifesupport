  ...
  <div id="inner-content">
      <main id="main" class="main" role="main" itemscope itemprop="mainContentOfPage" itemtype="http://schema.org/Blog">
        ...
        <header class="user-header">
          ...
          <?php if(wp_is_mobile()) : ?>
          <p class="userheader-bottom">HOME > <span>お客様の声 > </span><span>ご近所にバレずにあっという間に綺麗...</span></p>
          <?php else : ?>
          <p class="header-bottom">HOME > <span>お客様の声 > </span><span>ご近所にバレずにあっという間に綺麗になりました！</span></p>
          <?php endif; ?>
            ...
            <div class="uservoicedetails-menu">
              <div class="uservoicedetails-title">
                  ...
                  <h3>ご近所にバレずにあっという間に綺麗になりました！</h3>
                  <div class="border"></div>
                  
                <div class="inner-uservoicedetails">
                  <div class="uservoicedetails-blog">
                    <?php if(wp_is_mobile()) : ?>
                      <img src="<?php echo get_bloginfo('template_directory'); ?>/library/images/uservoice-details/sp-user-voice-details-5-1.jpg" alt="ゴミ屋敷の片付け依頼の女性">
                    <?php else : ?>
                      <img src="<?php echo get_bloginfo('template_directory'); ?>/library/images/uservoice-details/user-voice-details-5-1.jpg" alt="ゴミ屋敷の片付け依頼の女性">
                    <?php endif; ?>
                      <p>夫と子供が家にいなくなって、捨てたいものも捨てれずに時間が経ってしまいました。<br>
                        ご近所の目もありますし、思い切ってエコライフサポートさんに頼みました。<br>
                        人の少ない時間帯で作業してくださったので人目を気にせず綺麗になりました。<br>
                        </p>
                      <br>
                      <h2>ご近所にバレない気遣いをありがとうございます。</h2>
                    <?php if(wp_is_mobile()) : ?>
                      <img src="<?php echo get_bloginfo('template_directory'); ?>/library/images/uservoice-details/sp-user-voice-details-5-2.jpg" alt="ゴミ屋敷片付け後の部屋">
                    <?php else : ?>
                      <img src="<?php echo get_bloginfo('template_directory'); ?>/library/images/uservoice-details/user-voice-details-5-2.jpg" alt="ゴミ屋敷片付け後の部屋">
                    <?php endif; ?>
                      <p>最初は2部屋とも大荒れだったんですが、スタッフの方3人来ていただいたらあっという間に荷物をまとめてくれました。<br>
                          笑顔も素敵で気持ちよく利用できました。
                      </p>
                    <?php if(wp_is_mobile()) : ?>
                      <img src="<?php echo get_bloginfo('template_directory'); ?>/library/images/uservoice-details/sp-user-voice-details-5-3.jpg" alt="ゴミ屋敷片付け後の部屋">
                    <?php else : ?>
                      <img src="<?php echo get_bloginfo('template_directory'); ?>/library/images/uservoice-details/user-voice-details-5-3.jpg" alt="ゴミ屋敷片付け後の部屋">
                    <?php endif; ?>

                      <p>おかげさまでとても綺麗になりました。
                          あまりご近所に掃除をしてもらっているのを見られたくありませんでしたが、時間も人が少ない時間に対応してくれましたし、物音もなく静かに作業してくれました。<br>
                          あとは運び出す時に布を被せてくれたりなどの配慮が嬉しかったです。<br>
                          <br>
                          やはりご近所の方には家の中がこんなに散らかっていただなんて恥ずかしくて知られたくないのが本音だったので・・・<br>
                          <br>
                          これだけやっていただいて59,800円でした。<br>
                          もう破格ですよね。<br>
                          こんなに綺麗にしていただけたので、次からは散らからないように意識していこうと思います。
                          </p>
                          <br>
                        <div class="usage-table">
                            ...
                            <ul>
                              ...
                              <li class="itemtext4">
                                気持ちに寄り添ってくれながら依頼者目線で対応してくれるところ
                              </li>
                            </ul>
                            <div class="borderblue"></div>
                            </div>
