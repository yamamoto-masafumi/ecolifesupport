  ...
  <div id="inner-content">
      <main id="main" class="main" role="main" itemscope itemprop="mainContentOfPage" itemtype="http://schema.org/Blog">
        ...
        <header class="user-header">
          ...
          <?php if(wp_is_mobile()) : ?>
          <p class="userheader-bottom">HOME > <span>お客様の声 > </span><span>大きな家具や荷物も気にせず安心して...</span></p>
          <?php else : ?>
          <p class="header-bottom">HOME > <span>お客様の声 > </span><span>大きな家具や荷物も気にせず安心して詰め込めます！</span></p>
          <?php endif; ?>
            ...
            <div class="uservoicedetails-menu">
              <div class="uservoicedetails-title">
                  ...
                  <h3>大きな家具や荷物も気にせず安心して詰め込めます！</h3>
                  <div class="border"></div>
                  
                <div class="inner-uservoicedetails">
                  <div class="uservoicedetails-blog">
                    <?php if(wp_is_mobile()) : ?>
                      <img src="<?php echo get_bloginfo('template_directory'); ?>/library/images/uservoice-details/sp-user-voice-details-2-1.jpg" alt="不用品回収依頼の夫婦">
                    <?php else : ?>
                      <img src="<?php echo get_bloginfo('template_directory'); ?>/library/images/uservoice-details/user-voice-details-2-1.jpg" alt="不用品回収依頼の夫婦">
                    <?php endif; ?>
                      <p>定額なのが嬉しいですよね。<br>
                          他社が30万で見積もりを出したところ、その4分の1以下で引っ越しをすることができました。<br>
                          同じ作業をするなら安いところに越したことないですし、安かろう良かろうで大満足です！</p>
                      <br>
                      <h2>トータル作業してくれる親切さに感動！</h2>
                      <br>
                    <?php if(wp_is_mobile()) : ?>
                      <img src="<?php echo get_bloginfo('template_directory'); ?>/library/images/uservoice-details/sp-user-voice-details-2-2.jpg" alt="不用品回収風景">
                    <?php else : ?>
                      <img src="<?php echo get_bloginfo('template_directory'); ?>/library/images/uservoice-details/user-voice-details-2-2.jpg" alt="不用品回収風景">
                    <?php endif; ?>
                      <p>こんなに積み込んで7万円でした。<br>
                          荷物をきちんと部屋の中に取りに来てくれて、終わってない荷造りも手伝っていただけましたね。<br>
                          足腰が悪い私たちにとってはとても助かりました。</p>
                          <br>
                    <?php if(wp_is_mobile()) : ?>
                      <img src="<?php echo get_bloginfo('template_directory'); ?>/library/images/uservoice-details/sp-user-voice-details-2-3.jpg" alt="不用品回収後の部屋">
                    <?php else : ?>
                      <img src="<?php echo get_bloginfo('template_directory'); ?>/library/images/uservoice-details/user-voice-details-2-3.jpg" alt="不用品回収後の部屋">
                    <?php endif; ?>
                      <p>家中のものがすっぽりとあのトラックに入った時はびっくりしました。<br>
                          片付けや掃除まで手伝ってくれてサービスの手厚さを感じましたね。<br>
                          その時間およそ1時間。<br>
                          たったこれだけの時間で荷造り〜積み込み〜掃除まで終わるなんて思っていなかったです。
                          </p>
                          <br>
                    <?php if(wp_is_mobile()) : ?>
                      <img src="<?php echo get_bloginfo('template_directory'); ?>/library/images/uservoice-details/sp-user-voice-details-2-4.jpg" alt="引っ越し先の部屋">
                    <?php else : ?>
                      <img src="<?php echo get_bloginfo('template_directory'); ?>/library/images/uservoice-details/user-voice-details-2-4.jpg" alt="引っ越し先の部屋">
                    <?php endif; ?>
                      <p>また、引っ越し先では荷解きもしてくれて大変助かりました。<br>
                          こんなに早くて安く引っ越しができるなんて思っていなかったので、本当にエコライフサポートさんには感謝しています。<br>
                          また他の機会にでも利用できたらと思っていますので、よろしくお願いいたします。
                          </p>
                          <div class="user-text">
                            <h5>
                              ※ご本人の希望で画像はイメージです
                        ...
                        <p class="voicetitle">お客様の声</p>
                          ...
                          <div class="listbox">
                            <div class="imgbox">
                                ...
                                <span class="interviewee"><a href="<?php echo home_url('/user-voice/user4'); ?>">東京都 Yさん 一人暮らし</a></span>
                                <div class="borderblue"></div>
                            </div>
