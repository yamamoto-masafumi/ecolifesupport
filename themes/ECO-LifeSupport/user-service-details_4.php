  ...
  <div id="inner-content">
      <main id="main" class="main" role="main" itemscope itemprop="mainContentOfPage" itemtype="http://schema.org/Blog">
        ...
        <header class="user-header">
          ...
          <?php if(wp_is_mobile()) : ?>
          <p class="userheader-bottom">HOME > <span>お客様の声 > </span><span>たったの29,800円で！片付けもして...</span></p>
          <?php else : ?>
          <p class="header-bottom">HOME > <span>お客様の声 > </span><span>たったの29,800円で！片付けもしてくれて満足です。</span></p>
          <?php endif; ?>
            ...
            <div class="uservoicedetails-menu">
              <div class="uservoicedetails-title">
                  ...
                  <h3>たったの29,800円で！片付けもしてくれて満足です。</h3>
                  <div class="border"></div>
                  
                <div class="inner-uservoicedetails">
                  <div class="uservoicedetails-blog">
                    <?php if(wp_is_mobile()) : ?>
                      <img src="<?php echo get_bloginfo('template_directory'); ?>/library/images/uservoice-details/sp-user-voice-details-4-1.jpg" alt="ゴミ屋敷の片付け依頼の男性">
                    <?php else : ?>
                      <img src="<?php echo get_bloginfo('template_directory'); ?>/library/images/uservoice-details/user-voice-details-4-1.jpg" alt="ゴミ屋敷の片付け依頼の男性">
                    <?php endif; ?>
                      <p>男の一人暮らしで気付けばゴミ屋敷化。家中のゴミを回収で3万円台！<br>
                        おかげで綺麗な家で気持ちのいい暮らしです。<br>
                        あの時エコライフサポートさんに頼んでなければこの部屋はありません！<br>
                        ありがとうございます。
                        </p>
                      <br>
                      <h2>安い！早い！親切！圧巻のサービスに感無量。</h2>
                    <?php if(wp_is_mobile()) : ?>
                      <img src="<?php echo get_bloginfo('template_directory'); ?>/library/images/uservoice-details/sp-user-voice-details-4-2.jpg" alt="片付け前の部屋">
                    <?php else : ?>
                      <img src="<?php echo get_bloginfo('template_directory'); ?>/library/images/uservoice-details/user-voice-details-4-2.jpg" alt="片付け前の部屋">
                    <?php endif; ?>
                      <p>思い返せば、もう何がいるものかいらないものなのか正直わからないまま電話をしてしまったんですよね。<br>
                          エコライフサポートさんは30分で駆けつけてくれて、なんとゴミの荷造りまでしてくれたんですよ！
                      </p>
                          <br>
                    <?php if(wp_is_mobile()) : ?>
                      <img src="<?php echo get_bloginfo('template_directory'); ?>/library/images/uservoice-details/sp-user-voice-details-4-3.jpg" alt="片付け中の風景">
                    <?php else : ?>
                      <img src="<?php echo get_bloginfo('template_directory'); ?>/library/images/uservoice-details/user-voice-details-4-3.jpg" alt="片付け中の風景">
                    <?php endif; ?>
                      <p>その時間1時間！<br>
                          私の意見をきちんと聞いてくれた上でとても早い作業ペースでまとめてくれました。
                      </p>
                          <br>
                    <?php if(wp_is_mobile()) : ?>
                      <img src="<?php echo get_bloginfo('template_directory'); ?>/library/images/uservoice-details/sp-user-voice-details-4-4.jpg" alt="キレイな床">
                    <?php else : ?>
                      <img src="<?php echo get_bloginfo('template_directory'); ?>/library/images/uservoice-details/user-voice-details-4-4.jpg" alt="キレイな床">
                    <?php endif; ?>
                      <p>2部屋依頼してどちらもこの通り床が見えるくらい綺麗になりました。 <br>
                        せっかく綺麗になったことで今まで特に気にしていませんでしたが、部屋のインテリアにも今後力を入れていこうかなと思いました！ <br>
                        こんなに部屋が綺麗になって3万円！ <br>
                        定額の詰め放題乗せ放題なんてもの、もっと早く知りたかったですね。
                        </p>
                        <br>
                        <div class="usage-table">
                            ...
                            <ul>
                              ...
                              <li class="itemtext4">
                                驚くほど安い！しかも片付けや掃除までしてくれるサポートの手厚さ。
                              </li>
                            </ul>
                            <div class="borderblue"></div>
                            </div>
