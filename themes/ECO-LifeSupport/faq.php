  ...
  <div id="inner-content">
      ...
      <?php if(wp_is_mobile()) : ?>
        ...
        <div class="question-blue">
          ...
          <div class="list">
            <div class="list-question">
              <p>不用品・粗大ゴミの量がすごく少ないのですが大丈夫ですか？</p>
            </div>
            <div class="list-answer hidden">
              <p>
        ...
        <div class="question-purple">
          ...
          <div class="list">
            <div class="list-question">
              <p>粗大ゴミとして依頼しましたが買取への切り替えも可能ですか？</p>
            </div>
            <div class="list-answer hidden">
              <p>
                可能です。<br>
        ...
        <div class="question-white">
          ...
          <div class="list">
            <div class="list-question">
              <p>依頼者自身が遠方で立ち会うことができませんが可能ですか？</p>
            </div>
            <div class="list-answer hidden">
              <p>
                可能です。<br>
        ...
        <div class="question-pink">
          ...
          <div class="list">
            <div class="list-question">
              <p>生前処分を検討していますが、処分したらいいものを迷っています。</p>
            </div>
            <div class="list-answer hidden">
              <p>
                ご安心ください。<br>
        ...
        <div class="question-green">
          ...
          <div class="list">
            <div class="list-question">
              <p>出張見積りはいくらですか？駆けつけ可能時間を教えてください。</p>
            </div>
            <div class="list-answer hidden">
              <p>
                出張見積りは完全無料です。
