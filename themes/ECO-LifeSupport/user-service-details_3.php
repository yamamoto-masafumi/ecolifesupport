  ...
  <div id="inner-content">
      <main id="main" class="main" role="main" itemscope itemprop="mainContentOfPage" itemtype="http://schema.org/Blog">
        ...
        <header class="user-header">
          ...
          <?php if(wp_is_mobile()) : ?>
          <p class="userheader-bottom">HOME > <span>お客様の声 > </span><span>時間通りに来ていただけたのでとても...</span></p>
          <?php else : ?>
          <p class="header-bottom">HOME > <span>お客様の声 > </span><span>時間通りに来ていただけたのでとても助かりました！</span></p>
          <?php endif; ?>
            ...
            <div class="uservoicedetails-menu">
              <div class="uservoicedetails-title">
                  ...
                  <span class="interviewee">埼玉県 Tさん 一人暮らし</span>
                  <h3>時間通りに来ていただけたのでとても助かりました！</h3>
                  <div class="border"></div>
                  
                <div class="inner-uservoicedetails">
                  <div class="uservoicedetails-blog">
                    <?php if(wp_is_mobile()) : ?>
                      <img src="<?php echo get_bloginfo('template_directory'); ?>/library/images/uservoice-details/sp-user-voice-details-3-1.jpg" alt="不用品回収依頼の女性">
                    <?php else : ?>
                      <img src="<?php echo get_bloginfo('template_directory'); ?>/library/images/uservoice-details/user-voice-details-3-1.jpg" alt="不用品回収依頼の女性">
                    <?php endif; ?>
                      <p>パートの掛け持ちをしていて、その隙間時間に依頼をしました。<br>
                      最初は時間通りに来ていただけるか不安でしたが、きちんと指定の時間に来てくれて、なんと15分もしないうちに全ての作業が終了してプロ意識を感じました！</p>
                      <br>
                      <h2>融通を利かせてくれるお財布に優しい心遣いに感謝です！</h2>
                      <p>今回は大きなソファーだけでしたが、ドアに対して大きくて重たかったので私一人の力では移動が難しかったです。<br>
                          しかし、来てくれた女性スタッフの方が迅速に運んでくれてとても助かりました。<br>
                          価格も本当は9,980円からだったんですが、ソファーひとつだけということで3,000円になりました。<br>
                          色々と融通を利かせてくれてありがたいですね！<br>
                          後日、浮いたお金を新しいソファーに充てることが出来ました！
                          </p>
                          <br>
                    <?php if(wp_is_mobile()) : ?>
                      <img src="<?php echo get_bloginfo('template_directory'); ?>/library/images/uservoice-details/sp-user-voice-details-3-2.jpg" alt="新しいソファー">
                    <?php else : ?>
                      <img src="<?php echo get_bloginfo('template_directory'); ?>/library/images/uservoice-details/user-voice-details-3-2.jpg" alt="新しいソファー">
                    <?php endif; ?>
                      <p>家具が変わるだけで気持ちも変わりますね！<br>
