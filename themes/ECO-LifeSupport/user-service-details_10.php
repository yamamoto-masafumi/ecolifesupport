  ...
  <div id="inner-content">
      <main id="main" class="main" role="main" itemscope itemprop="mainContentOfPage" itemtype="http://schema.org/Blog">
        ...
        <header class="user-header">
          ...
          <?php if(wp_is_mobile()) : ?>
          <p class="userheader-bottom">HOME > <span>お客様の声 > </span><span>即日に安価で丁寧に整理をしてくれま...</span></p>
          <?php else : ?>
          <p class="header-bottom">HOME > <span>お客様の声 > </span><span>即日に安価で丁寧に整理をしてくれました。</span></p>
          <?php endif; ?>
            ...
            <div class="uservoicedetails-menu">
              <div class="uservoicedetails-title">
                  ...
                  <h3>即日に安価で丁寧に整理をしてくれました。</h3>
                  <div class="border"></div>
                <div class="inner-uservoicedetails">
                  <div class="uservoicedetails-blog">
                    <?php if(wp_is_mobile()) : ?>
                      <img src="<?php echo get_bloginfo('template_directory'); ?>/library/images/uservoice-details/sp-user-voice-details-10-1.jpg" alt="遺品整理依頼の女性">
                    <?php else : ?>
                      <img src="<?php echo get_bloginfo('template_directory'); ?>/library/images/uservoice-details/user-voice-details-10-1.jpg" alt="遺品整理依頼の女性">
                    <?php endif; ?>
                      <p>遺品整理の決心まで時間がかかりましたが、早めにしなくてはという気持ちに。<br>
                        すぐに対応してくださり感謝です。<br>
                        何から手をつけていいか迷いましたが、それもきちんと相談に乗ってくれて無事整理することが出来ました。
                        </p>
                      <br>
                      <h2>遺品整理をお願いから、買取対応で思った以上にお得に。</h2>
                      <p>最初、何を整理したらいいか迷っていましたが、スタッフの方々のアドバイスでいらない本やお洋服からまとめることに。<br>
                        まとめるときも辛い気持ちはありましたが、ずっと私の気持ちに寄り添ってくれてとても有意義な時間となりました。<br>
                        1時間ほどで作業は終了して、やっと気持ち的にも一区切りつけたような気がします。
                      </p>
                      <br>
                    <?php if(wp_is_mobile()) : ?>
                      <img src="<?php echo get_bloginfo('template_directory'); ?>/library/images/uservoice-details/sp-user-voice-details-10-2.jpg" alt="遺品整理後の部屋">
                    <?php else : ?>
                      <img src="<?php echo get_bloginfo('template_directory'); ?>/library/images/uservoice-details/user-voice-details-10-2.jpg" alt="遺品整理後の部屋">
                    <?php endif; ?>
                      <p>貴重品なども最後まとめて受け取り、誠実な対応に感謝しています。<br>
                        また、遺品整理としてお願いしましたが、カメラに関してはまだ使えるということで買取をしていただきました。
                        </p>
                        <br>
                    <?php if(wp_is_mobile()) : ?>
                      <img src="<?php echo get_bloginfo('template_directory'); ?>/library/images/uservoice-details/sp-user-voice-details-10-3.jpg" alt="買取のカメラ">
                    <?php else : ?>
                      <img src="<?php echo get_bloginfo('template_directory'); ?>/library/images/uservoice-details/user-voice-details-10-3.jpg" alt="買取のカメラ">
                    <?php endif; ?>
                        <p>そこそこ高価なものだとは思っていましたが、私自身使わないですし、主人が大切に使っていたカメラを他の方が使ってくださるならそれがいいと思いました。<br>
                        <br>
                          結構なお値段で買い取っていただけたので、最初の見積もりは10万円でしたが、買取のおかげで依頼した遺品整理料金は59,800円で済みました。<br>
                          細かな心遣いに感謝しています。
                          </p>
                          <br>
                        <div class="usage-table">
                            ...
                            <ul>
                              ...
                              <li class="itemtext4">
                                丁寧で寄り添った対応。買取れるものは買取などの提案などしてくれるところ。
                              </li>
                            </ul>
                            <div class="borderblue"></div>
                            </div>
