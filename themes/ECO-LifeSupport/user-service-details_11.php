  ...
  <div id="inner-content">
      <main id="main" class="main" role="main" itemscope itemprop="mainContentOfPage" itemtype="http://schema.org/Blog">
        ...
        <header class="user-header">
          ...
          <?php if(wp_is_mobile()) : ?>
          <p class="userheader-bottom">HOME > <span>お客様の声 > </span><span>片付けから荷造り、全て行っていただ...</span></p>
          <?php else : ?>
          <p class="header-bottom">HOME > <span>お客様の声 > </span><span>片付けから荷造り、全て行っていただけました。</span></p>
          <?php endif; ?>
            ...
            <div class="uservoicedetails-menu">
              <div class="uservoicedetails-title">
                  ...
                  <span class="interviewee">東京都 Mさん 遺品整理</span>
                  <h3>片付けから荷造り、全て行っていただけました。</h3>
                  <div class="border"></div>
                <div class="inner-uservoicedetails">
                  <div class="uservoicedetails-blog">
                    <?php if(wp_is_mobile()) : ?>
                      <img src="<?php echo get_bloginfo('template_directory'); ?>/library/images/uservoice-details/sp-user-voice-details-11-1.jpg" alt="遺品整理依頼の女性">
                    <?php else : ?>
                      <img src="<?php echo get_bloginfo('template_directory'); ?>/library/images/uservoice-details/user-voice-details-11-1.jpg" alt="遺品整理依頼の女性">
                    <?php endif; ?>
                      <p>両親の遺品整理をお願いしました。<br>
                        私自身足腰が弱いので遺品整理以外にも荷造りや分別、お掃除など手伝って欲しい旨を伝えたら快く作業してくれました。<br>
                        しかも掃除までやっていただいて追加料金0。<br>
                        良心的ですね。
                        </p>
                      <br>
                      <h2>遺品が整理されただけでなく心が軽くなりました。</h2>
                    <?php if(wp_is_mobile()) : ?>
                      <img src="<?php echo get_bloginfo('template_directory'); ?>/library/images/uservoice-details/sp-user-voice-details-11-2.jpg" alt="遺品整理中の様子">
                    <?php else : ?>
                      <img src="<?php echo get_bloginfo('template_directory'); ?>/library/images/uservoice-details/user-voice-details-11-2.jpg" alt="遺品整理中の様子">
                    <?php endif; ?>
                      <p>結構大きめの家具などを多く頼んだのですが、慣れた手つきで円滑に作業してくれました。<br>
                        最後は掃き掃除拭き掃除など行ってくれて、まるで変えたてのような床になりましたよ。<br>
                        まさかここまでやってくれるなんて思っていなかったのでびっくりです。
                      </p>
                      <br>
                    <?php if(wp_is_mobile()) : ?>
                      <img src="<?php echo get_bloginfo('template_directory'); ?>/library/images/uservoice-details/sp-user-voice-details-11-3.jpg" alt="畳で寝る孫">
                    <?php else : ?>
                      <img src="<?php echo get_bloginfo('template_directory'); ?>/library/images/uservoice-details/user-voice-details-11-3.jpg" alt="畳で寝る孫">
                    <?php endif; ?>
                      <p>綺麗になった床で孫も気持ち良さそうに寝ていました。<br>
                        スタッフの方々は終始感じのいい対応をしてくれて、遺品整理の作業はもちろん、両親を亡くした私たちのことを思う気持ちが伝わってくるあたたかい時間でした。<br>
                        ありがとうございます。
                        </p>
                        <br>
                        <div class="usage-table">
                            ...
                            <ul>
                              ...
                              <li class="itemtext4">
                                荷造りや分別まで行っていただいて追加料金0と言う良心的なサービス。
                              </li>
                            </ul>
                            <div class="borderblue"></div>
                            </div>
