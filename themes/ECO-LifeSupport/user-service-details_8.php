  ...
  <div id="inner-content">
      <main id="main" class="main" role="main" itemscope itemprop="mainContentOfPage" itemtype="http://schema.org/Blog">
        ...
        <header class="user-header">
          ...
          <?php if(wp_is_mobile()) : ?>
          <p class="userheader-bottom">HOME > <span>お客様の声 > </span><span>引っ越しで2DK分の荷物が他社見積りの...</span></p>
          <?php else : ?>
          <p class="header-bottom">HOME > <span>お客様の声 > </span><span>引っ越しで2DK分の荷物が他社見積りの3分の1で出来ました！</span></p>
          <?php endif; ?>
            ...
            <div class="uservoicedetails-menu">
              <div class="uservoicedetails-title">
                  ...
                  <span class="interviewee">千葉県 Kさん 引っ越し</span>
                  <h3>引っ越しで2DK分の荷物が他社見積りの3分の1で出来ました！</h3>
                  <div class="border"></div>
                <div class="inner-uservoicedetails">
                  <div class="uservoicedetails-blog">
                    <?php if(wp_is_mobile()) : ?>
                      <img src="<?php echo get_bloginfo('template_directory'); ?>/library/images/uservoice-details/sp-user-voice-details-8-1.jpg" alt="粗大ゴミ回収依頼の親子">
                    <?php else : ?>
                      <img src="<?php echo get_bloginfo('template_directory'); ?>/library/images/uservoice-details/user-voice-details-8-1.jpg" alt="粗大ゴミ回収依頼の親子">
                    <?php endif; ?>
                      <p>安すぎてびっくりしちゃいましたが、引っ越し費用を少しでも抑えたくて頼みました。<br>
                        他社よりも圧倒的に安く、安い裏に何かがあるのかなと思いましたが、終始丁寧な感じのいい対応で本当にエコライフサポートさんに頼んで良かったです！
                        </p>
                      <br>
                      <h2>14万円浮いて驚きです！</h2>
                    <?php if(wp_is_mobile()) : ?>
                      <img src="<?php echo get_bloginfo('template_directory'); ?>/library/images/uservoice-details/sp-user-voice-details-8-2.jpg" alt="粗大ゴミ回収の様子">
                    <?php else : ?>
                      <img src="<?php echo get_bloginfo('template_directory'); ?>/library/images/uservoice-details/user-voice-details-8-2.jpg" alt="粗大ゴミ回収の様子">
                    <?php endif; ?>
                      <p>服装も清潔感があり、気持ちよく対応してくれましたね。<br>
                        2DK分の荷物という大掛かりなものでしたが、6万円で行ってくれました。<br>
                        ちなみに某大手引っ越しセンターは繁忙期でもないのに20万円という見積もりでした。<br>
                      </p>
                      <br>
                    <?php if(wp_is_mobile()) : ?>
                      <img src="<?php echo get_bloginfo('template_directory'); ?>/library/images/uservoice-details/sp-user-voice-details-8-3.jpg" alt="引っ越し後のマンション">
                    <?php else : ?>
                      <img src="<?php echo get_bloginfo('template_directory'); ?>/library/images/uservoice-details/user-voice-details-8-3.jpg" alt="引っ越し後のマンション">
                    <?php endif; ?>
                      <p>不用品回収業者に引っ越しを頼む選択肢はありませんでしたが、あの時選択肢に入れて本当に良かったです！<br>
                        子どもにも笑顔で接してくれて本当に気持ちよく利用することができました。<br>
                        ありがとうございます。
                        </p>
                        <br>
                        <div class="usage-table">
                            ...
                            <ul>
                              ...
                              <li class="itemtext4">
                                とにかく安い。引っ越しするなら引っ越し業者の概念が覆されました。
                              </li>
                            </ul>
                            <div class="borderblue"></div>
                            </div>
