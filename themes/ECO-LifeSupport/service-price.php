          ...
          <div class="plan2">
            ...
            <div class="plan2-lists">
                ...
                <div class="plan-list">
                  ...
                  <div class="imgbox">
                    <?php if(wp_is_mobile()) : ?>
                      <img src="<?php echo get_bloginfo('template_directory'); ?>/library/images/service/sp-about-praice-light-pack2.png">
                    <?php else : ?>
                      <img src="<?php echo get_bloginfo('template_directory'); ?>/library/images/service/about-praice-light-pack2.png">
                    <?php endif; ?>
                  </div>
                  <p class="text">
                ...
                <div class="plan-list">
                  ...
                  <div class="imgbox">
                    <?php if(wp_is_mobile()) : ?>
                      <img src="<?php echo get_bloginfo('template_directory'); ?>/library/images/service/sp-about-praice-keitora-pack2.png">
                    <?php else : ?>
                      <img src="<?php echo get_bloginfo('template_directory'); ?>/library/images/service/about-praice-keitora-pack2.png">
                    <?php endif; ?>
                  </div>
                  <p class="text">
                ...
                <div class="plan-list">
                  ...
                  <div class="imgbox">
                    <?php if(wp_is_mobile()) : ?>
                      <img src="<?php echo get_bloginfo('template_directory'); ?>/library/images/service/sp-about-praice-1t-pack2.png">
                    <?php else : ?>
                      <img src="<?php echo get_bloginfo('template_directory'); ?>/library/images/service/about-praice-1t-pack2.png">
                    <?php endif; ?>
                  </div>
                  <p class="text">
                ...
                <div class="plan-list">
                  ...
                  <div class="imgbox">
                    <?php if(wp_is_mobile()) : ?>
                      <img src="<?php echo get_bloginfo('template_directory'); ?>/library/images/service/sp-about-praice-1-5t-pack2.png">
                    <?php else : ?>
                      <img src="<?php echo get_bloginfo('template_directory'); ?>/library/images/service/about-praice-1-5t-pack2.png">
                    <?php endif; ?>
                  </div>
                  <p class="text">
                ...
                <div class="plan-list">
                  ...
                  <div class="imgbox">
                    <?php if(wp_is_mobile()) : ?>
                      <img src="<?php echo get_bloginfo('template_directory'); ?>/library/images/service/sp-about-praice-2t-pack2.png">
                    <?php else : ?>
                      <img src="<?php echo get_bloginfo('template_directory'); ?>/library/images/service/about-praice-2t-pack2.png">
                    <?php endif; ?>
                  </div>
                  <p class="text">
                ...
                <div class="plan-list">
                  ...
                  <div class="imgbox">
                    <?php if(wp_is_mobile()) : ?>
                      <img src="<?php echo get_bloginfo('template_directory'); ?>/library/images/service/sp-about-praice-sangyouhaikibutu-pack2.png">
                    <?php else : ?>
                      <img src="<?php echo get_bloginfo('template_directory'); ?>/library/images/service/about-praice-sangyouhaikibutu-pack2.png">
                    <?php endif; ?>
                  </div>
                  <p class="text">
