...
function custom_post_example() { 
	...
	register_post_type( 'useful', /* (http://codex.wordpress.org/Function_Reference/register_post_type) */
		...
		array( 'labels' => array(
			...
			'rewrite'	=> array( 'slug' => 'useful', 'with_front' => false ), /* you can specify its url slug */
			'has_archive' => 'useful', /* you can rename the slug here */
	...
	register_taxonomy_for_object_type( 'category', 'useful' );
	/* this adds your post tags to your custom post type */
	register_taxonomy_for_object_type( 'post_tag', 'useful' );
