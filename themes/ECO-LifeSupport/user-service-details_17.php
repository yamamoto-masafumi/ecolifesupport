  ...
  <div id="inner-content">
      <main id="main" class="main" role="main" itemscope itemprop="mainContentOfPage" itemtype="http://schema.org/Blog">
        ...
        <header class="user-header">
          ...
          <?php if(wp_is_mobile()) : ?>
          <p class="userheader-bottom">HOME > <span>お客様の声 > </span><span>需要がないと思っていた洗濯機がまさ...</span></p>
          <?php else : ?>
          <p class="header-bottom">HOME > <span>お客様の声 > </span><span>需要がないと思っていた洗濯機がまさかこんな価格になるなんて....</span></p>
          <?php endif; ?>
            ...
            <div class="uservoicedetails-menu">
              <div class="uservoicedetails-title">
                  ...
                  <h3>需要がないと思っていた洗濯機がまさかこんな価格になるなんて....</h3>
                  <div class="border"></div>
                <div class="inner-uservoicedetails">
                  <div class="uservoicedetails-blog">
                    <?php if(wp_is_mobile()) : ?>
                      <img src="<?php echo get_bloginfo('template_directory'); ?>/library/images/uservoice-details/sp-user-voice-details-17-1.jpg" alt="不用品の買取依頼の女性">
                    <?php else : ?>
                      <img src="<?php echo get_bloginfo('template_directory'); ?>/library/images/uservoice-details/user-voice-details-17-1.jpg" alt="不用品の買取依頼の女性">
                    <?php endif; ?>
                      <p>どうせ売るなら高く買い取ってもらいたいと思いましたが、5年使い古した洗濯機は流石に値がつかないだろうと諦めていました。<br>
                        しかし、なんと5000円で買い取っていただき新しい洗濯機の調達金に回せそうです。<br>
                        ありがとうございました。
                        </p>
                      <br>
                      <h2>みなさん一度は問い合わせだけでもしてみるべきです！</h2>
                    <?php if(wp_is_mobile()) : ?>
                      <img src="<?php echo get_bloginfo('template_directory'); ?>/library/images/uservoice-details/sp-user-voice-details-17-2.jpg" alt="買取希望の洗濯機">
                    <?php else : ?>
                      <img src="<?php echo get_bloginfo('template_directory'); ?>/library/images/uservoice-details/user-voice-details-17-2.jpg" alt="買取希望の洗濯機">
                    <?php endif; ?>
                      <p>5年使用した結構年季の入った洗濯機でした。<br>
                        まだまだ動きますが、子どもがドラム式の洗濯機をくれたので廃棄処分をしようと考えていました。<br>
                        そこでエコライフサポートさんに粗大ゴミとしての処分を依頼しました。<br>
                        電話一本ですぐに引き取りに来てくれましたが、洗濯機の状態を確認してくれたスタッフさんから「古いけど状態もいいしきちんと動くので今回は買取もできますが....」<br>
                        と言われてぜひ！とお願いしました。<br>
                        その価格5000円。<br>
                        お金を払って処分してもらおうと思っていたので嬉しいです。
                      </p>
                      <br>
                    <?php if(wp_is_mobile()) : ?>
                      <img src="<?php echo get_bloginfo('template_directory'); ?>/library/images/uservoice-details/sp-user-voice-details-17-3.jpg" alt="新しい洗濯機">
                    <?php else : ?>
                      <img src="<?php echo get_bloginfo('template_directory'); ?>/library/images/uservoice-details/user-voice-details-17-3.jpg" alt="新しい洗濯機">
                    <?php endif; ?>
                      <p>おかげさまで新しいドラム式の洗濯機も来て生活がより豊かになりました。<br>
                        ドラム式をくれた子どもへのお礼に食事に誘い、洗濯機の買取で得た5000円を充てさせていただきました。<br>
                        <br>
                        こんなにお得な気分になってとてもいい気持ちです。<br>
                        今回エコライフサポートさんに頼んで本当に良かったです。
                        </p>
                        <br>
                        <div class="usage-table">
                            ...
                            <ul>
                              ...
                              <li class="itemtext4">
                                粗大ゴミの処分で依頼しても買取できるものは買取できるときちんと促してくれるところ。
                              </li>
                            </ul>
                            <div class="borderblue"></div>
                            </div>
