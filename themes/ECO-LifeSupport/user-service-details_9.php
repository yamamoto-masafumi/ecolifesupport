  ...
  <div id="inner-content">
      <main id="main" class="main" role="main" itemscope itemprop="mainContentOfPage" itemtype="http://schema.org/Blog">
        ...
        <header class="user-header">
          ...
          <?php if(wp_is_mobile()) : ?>
          <p class="userheader-bottom">HOME > <span>お客様の声 > </span><span>家に戻る事で家具が不要に。浮いたお...</span></p>
          <?php else : ?>
          <p class="header-bottom">HOME > <span>お客様の声 > </span><span>実家に戻る事で家具が不要に。浮いたお金で新しい家電が買えて嬉しい</span></p>
          <?php endif; ?>
            ...
            <div class="uservoicedetails-menu">
              <div class="uservoicedetails-title">
                  ...
                  <span class="interviewee">東京都 Sさん 引っ越し</span>
                  <h3>実家に戻る事で家具が不要に。浮いたお金で新しい家電が買えて嬉しい</h3>
                  <div class="border"></div>
                <div class="inner-uservoicedetails">
                  <div class="uservoicedetails-blog">
                    <?php if(wp_is_mobile()) : ?>
                      <img src="<?php echo get_bloginfo('template_directory'); ?>/library/images/uservoice-details/sp-user-voice-details-9-1.jpg" alt="粗大ゴミ回収依頼の親子">
                    <?php else : ?>
                      <img src="<?php echo get_bloginfo('template_directory'); ?>/library/images/uservoice-details/user-voice-details-9-1.jpg" alt="粗大ゴミ回収依頼の親子">
                    <?php endif; ?>
                      <p>実家に戻り両親と同居することに。<br>
                        実家には家具家電が使えるものがあるので、タンスや冷蔵庫など5点を粗大ゴミとして出しました。<br>
                        思った以上に安く2万円以内に収まり、浮いたお金で両親へマッサージチェアをプレゼントしました。
                        </p>
                      <br>
                      <h2>まさにお値段以上。気持ちよく利用できました</h2>
                    <?php if(wp_is_mobile()) : ?>
                      <img src="<?php echo get_bloginfo('template_directory'); ?>/library/images/uservoice-details/sp-user-voice-details-9-2.jpg" alt="プレゼントしたマッサージチェア">
                    <?php else : ?>
                      <img src="<?php echo get_bloginfo('template_directory'); ?>/library/images/uservoice-details/user-voice-details-9-2.jpg" alt="プレゼントしたマッサージチェア">
                    <?php endif; ?>
                      <p>両親も喜んでいて本当にエコライフサポートさんに頼んで良かったです♪<br>
                        今回２回目の依頼でしたが、以前と変わらず丁寧な対応をしてくれました。<br>
                        やはり決め手は圧倒的な安さですね。<br>
                        色々なところと比較した結果、最終的にエコライフサポートさんにたどり着きました。<br>
                        定額パックなのがといてもいいですね！<br>
                        見積もり料金と変わらないので安心して利用できます。
                      </p>
                      <br>
                    <?php if(wp_is_mobile()) : ?>
                      <img src="<?php echo get_bloginfo('template_directory'); ?>/library/images/uservoice-details/sp-user-voice-details-9-3.jpg" alt="エコライフサポートの女性スタッフ">
                    <?php else : ?>
                      <img src="<?php echo get_bloginfo('template_directory'); ?>/library/images/uservoice-details/user-voice-details-9-3.jpg" alt="エコライフサポートの女性スタッフ">
                    <?php endif; ?>
                      <p>女性スタッフの方もいて細やかな作業に安心感がありました。<br>
                        テキパキと作業をしてくださりとても気持ちの良い対応でまた機会があれば是非利用したいと考えています＾＾<br>
                        <br>
                        ありがとうございました。
                        </p>
                        <br>
