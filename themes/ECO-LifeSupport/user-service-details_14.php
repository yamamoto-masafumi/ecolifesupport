  ...
  <div id="inner-content">
      <main id="main" class="main" role="main" itemscope itemprop="mainContentOfPage" itemtype="http://schema.org/Blog">
        ...
        <header class="user-header">
          ...
          <?php if(wp_is_mobile()) : ?>
          <p class="userheader-bottom">HOME > <span>お客様の声 > </span><span>いらないものの相談などにも乗っても...</span></p>
          <?php else : ?>
          <p class="header-bottom">HOME > <span>お客様の声 > </span><span>いらないものの相談などにも乗ってもらい丁寧な対応！大満足です。</span></p>
          <?php endif; ?>

            <div class="uservoicedetails-menu">
              <div class="uservoicedetails-title">
                
                  <span class="label">生前処理　</span>
                  <span class="interviewee">東京都 Sさん 生前処分</span>
                  <h3>いらないものの相談などにも乗ってもらい丁寧な対応！大満足です。</h3>
                  <div class="border"></div>
                <div class="inner-uservoicedetails">
                  <div class="uservoicedetails-blog">
                    <?php if(wp_is_mobile()) : ?>
                      <img src="<?php echo get_bloginfo('template_directory'); ?>/library/images/uservoice-details/sp-user-voice-details-14-1.jpg" alt="生前処理依頼の男性">
                    <?php else : ?>
                      <img src="<?php echo get_bloginfo('template_directory'); ?>/library/images/uservoice-details/user-voice-details-14-1.jpg" alt="生前処理依頼の男性">
                    <?php endif; ?>
                      <p>70歳を過ぎて生前整理という言葉を意識するようになりました。<br>
                        でもどれから手をつけたらいいか分からずとりあえず問い合わせをしてみたのですが、丁寧にアドバイスをくれました。<br>
                        おかげですっきりした部屋になり思い残すことはありません。
                        </p>
                      <br>
                      <h2>親身に今後の相談に乗ってくれました。</h2>
                      <p>私の家は自分で言うのもあれですが、そこそこ大きい家で資産もあります。<br>
                        先日初期のガンを宣告され先のことを考えはじめました。<br>
                        身辺整理や財産のことなど自分で調べようにも調べられなくて、友人の紹介でエコライフサポートさんに依頼しました。
                      </p>
                      <br>
                    <?php if(wp_is_mobile()) : ?>
                      <img src="<?php echo get_bloginfo('template_directory'); ?>/library/images/uservoice-details/sp-user-voice-details-14-2.jpg" alt="家の中">
                    <?php else : ?>
                      <img src="<?php echo get_bloginfo('template_directory'); ?>/library/images/uservoice-details/user-voice-details-14-2.jpg" alt="家の中">
                    <?php endif; ?>
                      <p>荷物が多かったので搬出が必要になるものを作業日前にスタッフの方に来てもらい、整理後に必要になるものと不要になるものの事前査定をしてもらいました。<br>
                        そのおかげもあって作業当日の時間の負担をあまり感じませんでしたね。<br>
                        <br>
                        特に価値のある財産になりそうなものの判別がつきにくく困っていましたが、きちんと知見のある方が来てくださりスムーズに分別することができました！
                        </p>
                        <br>
                    <?php if(wp_is_mobile()) : ?>
                      <img src="<?php echo get_bloginfo('template_directory'); ?>/library/images/uservoice-details/sp-user-voice-details-14-3.jpg" alt="買取可能の時計">
                    <?php else : ?>
                      <img src="<?php echo get_bloginfo('template_directory'); ?>/library/images/uservoice-details/user-voice-details-14-3.jpg" alt="買取可能の時計">
                    <?php endif; ?>
                      <p>その中で整理中、この時計も捨てるとスタッフの方に伝えたら買取できる旨を聞き買取していただきました。<br>
                        買取は時計・食器・壺・タンスが買取対象となったみたいでその買取金額も想像以上で驚きです・・・<br>
                        <br>
                        スタッフの方はどなたも清潔感があり、気持ちよく利用できました。<br>
                        書類や財産となりそうなものなど相談に乗っていただき有意義な時間でしたね。
                        </p>
                        <div class="user-text">
                            <h5>
                              ※ご本人の希望で画像はイメージです
                        ...
                        <div class="usage-table">
                            ...
                            <ul>
                              ...
                              <li class="itemtext4">
                                買取知識もあるところ。時間や日程の調整も出来て前日に目星つける作業なども行えて当日作業が長引かない点。
                              </li>
                            </ul>
                            <div class="borderblue"></div>
                            </div>
