  ...
  <div id="inner-content">
      <main id="main" class="main" role="main" itemscope itemprop="mainContentOfPage" itemtype="http://schema.org/Blog">
        ...
        <header class="user-header">
          ...
          <?php if(wp_is_mobile()) : ?>
          <p class="userheader-bottom">HOME > <span>お客様の声 > </span><span>不用品回収で依頼していましたが、買...</span></p>
          <?php else : ?>
          <p class="header-bottom">HOME > <span>お客様の声 > </span><span>不用品回収で依頼していましたが、買取に切り替えてもらえてラッキー</span></p>
          <?php endif; ?>

            <div class="uservoicedetails-menu">
              <div class="uservoicedetails-title">
                
                  <span class="label">不用品の買取　</span>
                  <span class="interviewee">東京都 Tさん 不用品の買取</span>
                  <h3>不用品回収で依頼していましたが、買取に切り替えてもらえてラッキー</h3>
                  <div class="border"></div>
                <div class="inner-uservoicedetails">
                  <div class="uservoicedetails-blog">
                    <?php if(wp_is_mobile()) : ?>
                      <img src="<?php echo get_bloginfo('template_directory'); ?>/library/images/uservoice-details/sp-user-voice-details-18-1.jpg" alt="不用品の買取依頼の女性">
                    <?php else : ?>
                      <img src="<?php echo get_bloginfo('template_directory'); ?>/library/images/uservoice-details/user-voice-details-18-1.jpg" alt="不用品の買取依頼の女性">
                    <?php endif; ?>
                      <p>最初は不用品回収で大型家具家電をお願いしていましたが、スタッフさんがこれ買取でも大丈夫ですよと言ってくれました。<br>
                        おかげで不用品回収費用を払うはずが、回収してくれたしお金も入って来るしでとてもお得な気分になりました！
                        </p>
                      <br>
                      <h2>ゴミがお金になるなんて。</h2>
                    <?php if(wp_is_mobile()) : ?>
                      <img src="<?php echo get_bloginfo('template_directory'); ?>/library/images/uservoice-details/sp-user-voice-details-18-2.jpg" alt="買取してもらった家具家電">
                    <?php else : ?>
                      <img src="<?php echo get_bloginfo('template_directory'); ?>/library/images/uservoice-details/user-voice-details-18-2.jpg" alt="買取してもらった家具家電">
                    <?php endif; ?>
                      <p>彼氏と同棲するために家具家電を処分したかったんですが、処分品はまだまだ使えるけど、そんなに超綺麗！ってわけでもなかったんですよね。<br>
                        最初から買取の選択は入ってなくて、不用品回収として友人がオススメしてくれたエコライフサポートに依頼をしました。<br>
                        友人がここが一番安く回収してくれたと言っていたので。
                      </p>
                      <br>
                    <?php if(wp_is_mobile()) : ?>
                      <img src="<?php echo get_bloginfo('template_directory'); ?>/library/images/uservoice-details/sp-user-voice-details-18-3.jpg" alt="見積書">
                    <?php else : ?>
                      <img src="<?php echo get_bloginfo('template_directory'); ?>/library/images/uservoice-details/user-voice-details-18-3.jpg" alt="見積書">
                    <?php endif; ?>
                      <p>電話をしたらすぐにコールセンターの方が出てくれて、親身に話を聞いてくれました。<br>
                        今はもうほぼほぼ彼氏の家に転がり込んでいる状態だったのでもう家具はいらないと思い、30分後に引き取りに来てもらうようお願いしました。<br>
                        来てもらったところ、特に大きな傷もなく状態もいいので買取ということになりました。<br>
                        4点出した中で4点ともですよ！？<br>
                        びっくりしましたし、全て合わせて3万円も値がつきました。
                        </p>
                        <br>
                    <?php if(wp_is_mobile()) : ?>
                      <img src="<?php echo get_bloginfo('template_directory'); ?>/library/images/uservoice-details/sp-user-voice-details-18-4.jpg" alt="現金買取">
                    <?php else : ?>
                      <img src="<?php echo get_bloginfo('template_directory'); ?>/library/images/uservoice-details/user-voice-details-18-4.jpg" alt="現金買取">
                    <?php endif; ?>
                      <p>スタッフさんに聞いたら需要があるとのこと。<br>
                        中古家具家電を見に来るお客さんも多いことから高額買取が成り立ってるとのこと。<br>
                        自分からしたら捨てるしゴミみたいなものでしたが、それがお金に変わるってまさに棚からぼた餅ですね！<br>
                        ありがとうございました。
                      </p>
					  			<div class="user-text">
                            <h5>
                        ...
                        <div class="usage-table">
                            ...
                            <ul>
                              ...
                              <li class="itemtext4">
                                現金買取で助かりました。思った以上に高い買取でお得感あります。
                              </li>
                            </ul>
                            <div class="borderblue"></div>
                            </div>
                      ...
                      <p class="article">不用品の買取の関連記事</p>
                        ...
                        <div class="uservoice-list">
                          ...
                          <a href="<?php echo home_url('/user-voice/user16'); ?>"><img src="<?php echo get_bloginfo('template_directory'); ?>/library/images/user-voice/user-voice16.jpg"></a>
                            <span class="labelpc">不用品の買取</span>
                          </div>
                              <p class="title">東京都 Nさん 不用品の買取</p>
                              <p class="text"><a href="<?php echo home_url('/user-voice/user16'); ?>"><span class="detail">他社の提示金額より2倍の値段で買い取ってもらえました。</span></a></p>
                              <div class="borderblue"></div>
                    ...
                    <div class="uservoicelisttitle">
                        ...
                        <div class="listbox">
                          ...
                          <div class="inner">
                            ...
                            <div class="labeltext">
                                <p class="label">ゴミ屋敷の片付け　</p>
                                <p class="interviewee"><a href="<?php echo home_url('/user-voice/user4'); ?>">東京都 Yさん 一人暮らし</a></p>
                            </div>
                          </div>
                          <div class="borderblue"></div>
                          ...
                          <div class="inner">
                            ...
                            <div class="labeltext">
                                ...
                                <p class="interviewee"><a href="<?php echo home_url('/user-voice/user7'); ?>">埼玉県県 Nさん 引っ越し</a></p>
                            </div>
                          </div>
                          <div class="borderblue"></div>
                    ...
                    <div class="uservoicelisttitle">
                        ...
                        <p class="voicetitle">お客様の声</p>
                          ...
                          <div class="listbox">
                            ...
                            <div class="imgbox">
                                  <a href="<?php echo home_url('/user-voice/user4'); ?>"><div class="pcimg"><img src="<?php echo get_bloginfo('template_directory'); ?>/library/images/user-voice/user-voice4.jpg"></div></a>
                                  <span class="label">ゴミ屋敷の片付け　</span><br>
                                  <span class="interviewee"><a href="<?php echo home_url('/user-voice/user4'); ?>">東京都 Yさん 引っ越し</a></span>
                                  <div class="borderblue"></div>
                            </div>
