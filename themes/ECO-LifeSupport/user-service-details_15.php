  ...
  <div id="inner-content">
      <main id="main" class="main" role="main" itemscope itemprop="mainContentOfPage" itemtype="http://schema.org/Blog">
        ...
        <header class="user-header">
          ...
          <?php if(wp_is_mobile()) : ?>
          <p class="userheader-bottom">HOME > <span>お客様の声 > </span><span>施設入所前の片付けで依頼。丁寧で気...</span></p>
          <?php else : ?>
          <p class="header-bottom">HOME > <span>お客様の声 > </span><span>施設入所前の片付けで依頼。丁寧で気持ちよく利用できました。</span></p>
          <?php endif; ?>
            ...
            <div class="uservoicedetails-menu">
              <div class="uservoicedetails-title">
                  ...
                  <span class="interviewee">千葉県 Iさん 生前処分</span>
                  <h3>施設入所前の片付けで依頼。丁寧で気持ちよく利用できました。</h3>
                  <div class="border"></div>
                <div class="inner-uservoicedetails">
                  <div class="uservoicedetails-blog">
                    <?php if(wp_is_mobile()) : ?>
                      <img src="<?php echo get_bloginfo('template_directory'); ?>/library/images/uservoice-details/sp-user-voice-details-15-1.jpg" alt="生前処理依頼の女性">
                    <?php else : ?>
                      <img src="<?php echo get_bloginfo('template_directory'); ?>/library/images/uservoice-details/user-voice-details-15-1.jpg" alt="生前処理依頼の女性">
                    <?php endif; ?>
                      <p>家を引き払い、施設に行こうと考えた時この荷物や家具はどうしたらいいのか分からず、孫の紹介でエコライフサポートさんに依頼をしました。<br>
                        荷造りや片付け、入居するための荷物の取捨選択など一緒に考えていただき本当に助かりました。
                        </p>
                      <br>
                      <h2>サポート体制が素晴らしい。</h2>
                    <?php if(wp_is_mobile()) : ?>
                      <img src="<?php echo get_bloginfo('template_directory'); ?>/library/images/uservoice-details/sp-user-voice-details-15-2.jpg" alt="作業中の様子">
                    <?php else : ?>
                      <img src="<?php echo get_bloginfo('template_directory'); ?>/library/images/uservoice-details/user-voice-details-15-2.jpg" alt="作業中の様子">
                    <?php endif; ?>
                      <p>いるものといらないものの取捨選択〜荷造り〜積込み〜お掃除〜退去手続きまで一貫して行っていただきました。<br>
                      <br>
                        足腰の弱い私に代わりに何から何まで嫌な顔一つせずありがとうございました。<br>
                        それでもかかる料金は詰込み運送費のパック料金のみでしたので、不用品回収と施設に送る荷物詰込みで3万円かからないくらいで驚きです。<br>
                      <br>
                        身辺整理や財産のことなど自分で調べようにも調べられなくて、友人の紹介でエコライフサポートさんに依頼しました。
                      </p>
                      <br>
                    <?php if(wp_is_mobile()) : ?>
                      <img src="<?php echo get_bloginfo('template_directory'); ?>/library/images/uservoice-details/sp-user-voice-details-15-3.jpg" alt="施設の憩いの場">
                    <?php else : ?>
                      <img src="<?php echo get_bloginfo('template_directory'); ?>/library/images/uservoice-details/user-voice-details-15-3.jpg" alt="施設の憩いの場">
                    <?php endif; ?>
                      <p>おかげさまで施設にも予定通りに入ることができました。<br>
                        荷物も綺麗にまとめていただけたので何も問題なく移動ができ、エコライフサポートさんに頼んで良かったなと思っています。<br>
                        ありがとうございました。
                        </p>
                        <div class="user-text">
                            <h5>
                        ...
                        <div class="usage-table">
                            ...
                            <ul>
                              ...
                              <li class="itemtext4">
                                自分の代わりに相談から荷造り、手続き等一貫して親身に対応してくれたところ
                              </li>
                            </ul>
                            <div class="borderblue"></div>
                            </div>
